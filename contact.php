...
<html lang="en">
	...
	<body class="animated-css" data-scrolling-animations="false" id="ContactSrc">
      ...
      <!-- icon-menu -->
			...
			<section id="pageTitleBox" class="paralax breadcrumb-container"  style="background-image: url('images/contact1.jpg'); height: 200px; margin-bottom: 50px; margin-top: 50px;">
				<!-- <div class="overlay"></div> -->
				<div class="container relative">
					<h1 class="title font-additional font-weight-normal color-main text-uppercase wow zoomIn customColor" data-wow-delay="0.3s">CONTACT US</h1>
					<ul class="breadcrumb-list wow zoomIn" data-wow-delay="0.3s">
						...
						<li>
							<a href="category.php" class="font-additional font-weight-normal color-main text-uppercase customColor">CONTACT</a>
						</li>						
					</ul>
				</div>
			</section>
...
<div>          <script>
          ...
          <script async defer
                  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCwwWPn9l9OeAeTIThaucXalztLYWQfxrs&callback=initMap">
          </script>
</div>
          <!-- Map -->
