	...
	<body class="animated-css" data-scrolling-animations="false">
      ...
      <!-- End Switcher -->
                    ...
                    <ul role="menu" class="dropdown-menu header-cart_product_list">
                      <li class="added-items">
                        <div class="header-cart_product_list_item clearfix">
                          <a class="item-preview" href="product-details-1.php"><img src="images/stylemenn.jpg" alt="Product"></a>
                          <h4><a class="font-additional font-weight-normal hover-focus-color cart-product-title" href="product-details-1.php">Men HandMade</a></h4>
                      ...
                      <li class="added-items">
                        <div class="header-cart_product_list_item clearfix">
                          <a class="item-preview" href="product-details-1.php"><img src="images/smallbag.jpg" alt="Product"></a>
                          <h4><a class="font-additional font-weight-normal hover-focus-color cart-product-title" href="product-details-1.php">Bag</a></h4>
                          <span class="item-cat font-main font-weight-normal"><a class="hover-focus-color cart-product-category" href="#">Women HandMade</a></span>
                          <span class="item-price font-additional font-weight-normal customColor">60.10 $</span>
                          <a class="item-del hover-focus-color" href="#"><i class="fa fa-trash-o"></i></a>
                        </div>
                      </li>
                    </ul>
          ...
          <!-- icon-menu -->
			...
			<section id="pageTitleBox" class="paralax breadcrumb-container"  style="background-image: url('images/catgoery1.PNG');">
				<div class="overlay"></div>
				<div class="container relative">
					<h1 class="title font-additional font-weight-normal color-main text-uppercase wow zoomIn" data-wow-delay="0.3s">Shop Category</h1>
					<ul class="breadcrumb-list">
						<li>
							<a href="index.php" class="font-additional font-weight-normal color-main text-uppercase">HOME</a>
							<span><i class="fa fa-angle-double-right"></i></span>
						</li>
						<a href="blog.php" class="font-additional font-weight-normal color-main text-uppercase">about us</a>
					</ul>
				</div>
			</section>
              ...
              <div class="row">
                <div class="sidebar col-lg-3 col-md-3 col-sm-3 col-xs-12 clearfix">
                  ...
                  <ul class="sidebar-popular-product wow fadeIn" data-wow-delay="0.6s">
                    <li>
                      <a class="popular-product-item" href="product-details-1.php">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 clearfix">
                    ...
                    <span>View as:</span>
                    <a href="category.php" class="grid-type">
                      Grid
                    </a>
                    <span class="slash-seperator">/</span>
                    <a href="category-1.php" class="grid-type category-active">
                      List
                    </a>
                  </div>
                  ...
                  <div class="select sort-select pull-left">
                    ...
                    <select class="select-field font-main color-third" name="sort" id="sort">
								...
								<div class="products-cat product-list-cat product-margin-top clearfix">
                  ...
                  <ul class="products-list">
                      ...
                      <div class="product-list_item row">
                        <div class="product-list_item_img col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                          <a href="product-details-1.php">
                            <img class="product-list_item_img hvr-grow" src="images/SocksHM.jpg" alt="Product">
                          </a>
                        </div>
                          ...
                          <div class="product-list-info">
                            <div class="product-list_item_title">
                              <h3 class="font-additional font-weight-bold text-uppercase">
                                <a href="product-details-1.php">socks HandMade</a>
                              </h3>
                              <ul class="rating">
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star color-additional" aria-hidden="true"></span></li>
                              </ul>
                            </div>
                            <div class="product-item_price font-additional font-weight-normal customColor">$240.00 <span>$265.00</span></div>
                            <div class="product-list_item_desc font-main font-weight-normal color-third">Check out our socks handmade selection for the very best in unique or custom, handmade pieces from our HandMade shop, The best hand-knit wool slipper socks and cold weather accessories for men and women.</div>
                            <a href="#" class="btn button-additional font-additional font-weight-normal text-uppercase hvr-bounce-to-right before-bg">
                    ...
                    <li class="wow fadeIn" data-wow-delay="0.3s">
                      <div class="product-list_item row">
                        <div class="product-list_item_img col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                          <a href="product-details-1.php">
                            <img class="product-list_item_img hvr-grow" src="images/BabiHM.jpg" alt="Product">
                          </a>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 clearfix">
                          <div class="product-list-info">
                            <div class="product-list_item_title">
                              <h3 class="font-additional font-weight-bold text-uppercase">
                                <a href="product-details-1.php">Babies HandMade</a>
                              </h3>
                              <ul class="rating">
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                            ...
                            <div class="product-item_price font-additional font-weight-normal customColor">$115.00</div>
                            <div class="product-list_item_desc font-main font-weight-normal color-third">Creating handmade gifts for babies is the sweetest way to welcome those new little ones into the world! Many baby gifts are small and simple so you don’t need a ton of time to make the cutest little hats, blankets and bibs!</div>
                            <a href="#" class="btn button-additional font-additional font-weight-normal text-uppercase hvr-bounce-to-right before-bg">
                              <span class="icon-basket" aria-hidden="true"></span>
                              add to cart
                            </a>                            
                    ...
                    <li class="wow fadeIn" data-wow-delay="0.3s">
                      <div class="product-list_item row">
                        <div class="product-list_item_img col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                          <a href="product-details-1.php">
                            <img class="product-list_item_img hvr-grow" src="images/W3Hw.jpg" alt="Product">
                          </a>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 clearfix">
                          <div class="product-list-info">
                            <div class="product-list_item_title">
                              <h3 class="font-additional font-weight-bold text-uppercase">
                                <a href="product-details-1.php">HandMade For women</a>
                              </h3>
                              <ul class="rating">
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                            ...
                            <div class="product-item_price font-additional font-weight-normal customColor">$60.50</div>
                            <div class="product-list_item_desc font-main font-weight-normal color-third">You searched for Uniquie bags and purses handmade! HandMade Shop is the home to thousands of handmade, vintage, and one-of-a-kind products and gifts related to your search.</div>
                            <a href="#" class="btn button-additional font-additional font-weight-normal text-uppercase hvr-bounce-to-right before-bg">
                              <span class="icon-basket" aria-hidden="true"></span>
                              add to cart
                            </a>                            
                    ...
                    <li class="wow fadeIn" data-wow-delay="0.3s">
                      <div class="product-list_item row">
                        <div class="product-list_item_img product-list_item_img col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                          <a href="product-details-1.php">
                            <img class="product-list_item_img hvr-grow" src="images/Menj.jpg" alt="Product">
                          </a>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 clearfix">
                          <div class="product-list-info">
                            <div class="product-list_item_title">
                              <h3 class="font-additional font-weight-bold text-uppercase">
                                <a href="product-details-1.php">Men HandMen</a>
                              </h3>
                              <ul class="rating">
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                            ...
                            <div class="product-item_price font-additional font-weight-normal customColor">$350.00 <span>$300.00</span></div>
                            <div class="product-list_item_desc font-main font-weight-normal color-third"> we provide  handmade accessories for Men ,. </div>
                            <a href="#" class="btn button-additional font-additional font-weight-normal text-uppercase hvr-bounce-to-right before-bg">
                              <span class="icon-basket" aria-hidden="true"></span>
                              add to cart
                            </a>                            
                    ...
                    <li class="wow fadeIn" data-wow-delay="0.3s">
                      <div class="product-list_item row">
                        <div class="product-list_item_img col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                          <a href="product-details-1.php">
                            <img class="product-list_item_img hvr-grow" src="images/wowring.jpg" alt="Product">
                          </a>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 clearfix">
                          <div class="product-list-info">
                            <div class="product-list_item_title">
                              <h3 class="font-additional font-weight-bold text-uppercase">
                                <a href="product-details-1.php">Ring HandMade</a>
                              </h3>
                              <ul class="rating">
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                            ...
                            <div class="product-item_price font-additional font-weight-normal customColor">$99.00</div>
                            <div class="product-list_item_desc font-main font-weight-normal color-third">A collection of unique handmade hair accessories for every day, nature and beach inspired hair accessories, Bee Bobby Pins, Star Bobby Pins, Feather ...</div>
                            <a href="#" class="btn button-additional font-additional font-weight-normal text-uppercase hvr-bounce-to-right before-bg">
                              <span class="icon-basket" aria-hidden="true"></span>
                              add to cart
                            </a>                            
                    ...
                    <li class="wow fadeIn" data-wow-delay="0.3s">
                      <div class="product-list_item row">
                        <div class="product-list_item_img col-lg-4 col-md-4 col-sm-4 col-xs-12 clearfix">
                          <a href="product-details-1.php">
                            <img class="product-list_item_img hvr-grow" src="images/soap.jpg" alt="Product">
                          </a>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 clearfix">
                          <div class="product-list-info">
                            <div class="product-list_item_title">
                              <h3 class="font-additional font-weight-bold text-uppercase">
                                <a href="product-details-1.php">Soap HandMade</a>
                              </h3>
                              <ul class="rating">
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                                <li><span class="icon-star customColor" aria-hidden="true"></span></li>
                            ...
                            <div class="product-item_price font-additional font-weight-normal customColor">$29.60</div>
                            <div class="product-list_item_desc font-main font-weight-normal color-third">Our 100% all-natural handmade soaps feel a little better because they are made ... The result is an affordable, all-natural soap that is not only beautiful to look </div>
                            <a href="#" class="btn button-additional font-additional font-weight-normal text-uppercase hvr-bounce-to-right before-bg">
                              <span class="icon-basket" aria-hidden="true"></span>
                              add to cart
                            </a>                            
              ...
              <form action="#" method="post">
                <div id="mc_embed_signup_scroll">
                  ...
                  <div class="mc-field-group subscribe-field">
                    <input type="email" value="" name="Email" class="required email font-main color-third" id="Email" required>
                  </div>
